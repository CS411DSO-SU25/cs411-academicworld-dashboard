...
def register_callbacks(app):
    ...
    def load_top_cited_table(selected_prof):
        ...
        if pub_ids:
            ...
            kw_sql = (
                ...
                f"WHERE pk.publication_id IN ({format_strings})"
            )
    ...
    def update_research_interests(n_clicks, selected_prof, table_data):
        if not n_clicks or not selected_prof or not table_data:
        ...
        return dash.no_update, f"{selected_prof} updated {now_str}"
